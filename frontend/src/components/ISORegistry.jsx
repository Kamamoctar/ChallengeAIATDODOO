...
/* ─── Badge renderer ────────────────────────────────────── */
const LEVEL_STYLES = {
  H:         { bg: '#fef2f2', color: '#dc2626' },
  M:         { bg: '#fffbeb', color: '#d97706' },
  L:         { bg: '#f0fdf4', color: '#16a34a' },
  Élevé:     { bg: '#fef2f2', color: '#dc2626' },
  Moyen:     { bg: '#fffbeb', color: '#d97706' },
  Faible:    { bg: '#f0fdf4', color: '#16a34a' },
  Critique:  { bg: '#fef2f2', color: '#dc2626' },
  Approuvé:  { bg: '#f0fdf4', color: '#16a34a' },
  Rejeté:    { bg: '#fef2f2', color: '#dc2626' },
  Annulé:    { bg: '#f8f9fa', color: '#94a3b8' },
  Livré:     { bg: '#f0fdf4', color: '#16a34a' },
  Accepté:   { bg: '#f0fdf4', color: '#16a34a' },
  Positif:   { bg: '#f0fdf4', color: '#16a34a' },
  Négatif:   { bg: '#fef2f2', color: '#dc2626' },
  Clôturé:   { bg: '#f3e8ff', color: '#7c3aed' },
}
